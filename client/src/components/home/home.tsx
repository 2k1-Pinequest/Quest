      ...
      <div className="w-full max-w-4xl">
        <div className="text-center mb-12">
          ...
          <p className="text-base md:text-xl text-gray-600 font-medium max-w-2xl mx-auto">
            AI-гаар гэрийн даалгавар үнэлэх, санал хүсэлт өгөх, ахиц дэвшлийг
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <Link href={"/teacherRoom"}>
            <button
              className="w-full bg-white rounded-2xl shadow-xl p-8 text-center transform hover:scale-105 transition-all duration-300 cursor-pointer group"
            >
